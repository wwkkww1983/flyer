...
try:
    ...
    QtWidgets.QMessageBox.critical(None, "飞控板控制",
...
class FCWindow(QtWidgets.QWidget):
    def __init__(self):
...
class FCComWidget(QtWidgets.QWidget):
...
class FCPostWidget(QtWidgets.QWidget):
    def __init__(self):
        super(FCPostWidget, self).__init__()

class FCCtrlWidget(QtWidgets.QWidget):
