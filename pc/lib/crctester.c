...
int main() {
	...
	printf(" crc bit by bit      :  0x%x\n", crcbitbybit((unsigned char *)string, sizeof(string)));
	printf(" crc bit by bit fast :  0x%x\n", crcbitbybitfast((unsigned char *)string, sizeof(string)));
	if (!(order&7)) printf(" crc table           :  0x%x\n", crctable((unsigned char *)string, sizeof(string)));
	if (!(order&7)) printf(" crc table fast      :  0x%x\n", crctablefast((unsigned char *)string, sizeof(string)));
