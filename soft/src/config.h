...
#define FILTER_ACCEL_1FACTOR_LAST_RATE                      (0.95f)
/* 加计滤波比例参数 [2,无穷) 值增则平滑,采样率降 */
#define FILTER_ACCEL_AVERAGE_NUMS                           (20)
/* 融合算法参数 */
#define FILTER_FUSION_ACCEL_THETA_RATE                      (1.0f)
#define FILTER_FUSION_ACCEL_PHI_RATE                        (1.0f)
